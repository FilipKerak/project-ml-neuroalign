...
z09_01={}
z09_09={}
with open("sliced_01_fixed_ref01.paf",'r')as s:
    for r in s:
        h=r.split()
        if h[4]=='-':
            continue
...
with open("sliced_01_fixed_ref09.paf",'r')as s:
    for r in s:
        h=r.split()
        if h[4]=='-':
            continue
...
with open("sliced_09_fixed_ref01.paf",'r')as s:
    for r in s:
        h=r.split()
        if h[4]=='-':
            continue
...
with open("sliced_09_fixed_ref09.paf",'r')as s:
    for r in s:
        h=r.split()
        if h[4]=='-':
            continue
...
res=[]
for s in SeqIO.parse("sliced_09_fixed.fastq","fastq"):
...
for s in SeqIO.parse("sliced_01_fixed.fastq","fastq"):
